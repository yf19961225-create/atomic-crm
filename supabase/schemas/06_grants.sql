...
revoke all on table public.romiku_formal_customer_directory from public, anon;
grant select on table public.romiku_formal_customer_directory to authenticated, service_role;
